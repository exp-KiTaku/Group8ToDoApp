...
export interface ITaskService {
  ...
  getTasksByCategory(category: Category): Promise<ITask[]>;
  getTaskArgsByCategory(category: Category): Promise<TaskArgs[]>;
  getTaskArgsByStatus(status: 'uncompleted' | 'completed' | 'deadline-passed'): Promise<TaskArgs[]>;
  getTaskArgsByCategoryAndStatus(category: Category, status: 'uncompleted' | 'completed' | 'deadline-passed'): Promise<TaskArgs[]>;
